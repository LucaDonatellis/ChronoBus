...
mongoose.connect(
	'mongodb+srv://lorenzociroluongo:QvmW8bxBiyZIpDRo@cluster0.dthxrpi.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
);
...
export async function POST({ request }) {
	...
	try {
		...
		if (
			!line ||
			typeof time !== 'number' ||
			!['almost_empty', 'empty_seats', 'seats_full', 'crowded', 'overcrowded'].includes(crowdedness)
		) {
